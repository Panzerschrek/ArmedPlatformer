...
TileId TileForChar(const char c)
{
	...
	case 'a': return TileId::Dirt;
	case 'b': return TileId::DirtWithGrass;
	case 'c': return TileId::DirtLower;
	case 'd': return TileId::PawedDirt;

	case 'e': return TileId::TechnoBlock;
